  ...
  return <div className="setup-panel">
    ...
    <ul className="setup-checklist">
      ...
      <li className={status.chat_running&&status.embed_running?"done":""}>
        ...
        {status.chat_model_installed&&status.embed_model_installed&&(!status.chat_running||!status.embed_running)&&<button className="quiet-button" disabled={!!busy} onClick={()=>run("setup_start_engine",()=>invoke("setup_start_engine"))}>{busy==="setup_start_engine"?"Starting…":"Start"}</button>}
      </li>
    </ul>
    {progressBar}
